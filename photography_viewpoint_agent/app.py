...
def main(argv=None) -> int:
    ...
    parser.add_argument('--viewpoint-backend', choices=['homography', 'depth_3d', 'depth_mesh'], default='homography')
    parser.add_argument('--viewpoint-horizontal-fov-deg', type=float, default=60)
    parser.add_argument('--viewpoint-border-mode', choices=['constant', 'replicate'], default='constant')
